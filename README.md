...
**Game menu & betting windows.** `.g` (or `/games`) opens a layered button menu — Casino, Table Games, Economy, Item Shop, Stats — with no typing. Typing a game name alone, like `.slots` or `.blackjack`, opens a **betting window**: a styled embed with **½ / ×2** to adjust the bet, **✏️ Amount** for an exact figure, **💰 All In** (with a max-bet confirmation), a dropdown for game options (coinflip side, plinko risk, roulette target…), and a **▶ Play** button. Power users can still bet inline: `.slots 500`, `.roulette 100 17`, `.bj 1k`.
